...
## Project Structure
    ...
    ├── challenge_fitness_38615  # Django project configurations
...
1. Clone this repo and `cd challenge_fitness_38615`
...
2. Clone this repo and `cd challenge_fitness_38615`
